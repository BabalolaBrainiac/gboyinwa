    ...
    <div className="flex flex-col min-h-screen bg-white dark:bg-brand-black">
      ...
      <main className="flex-1">
        ...
        <section className="relative min-h-[90vh] flex items-center overflow-hidden pt-20">
          ...
          <div className="absolute -top-20 -left-20 w-[500px] h-[500px] rounded-full bg-brand-yellow/5 dark:bg-brand-yellow/3 blur-[100px] pointer-events-none" />
          <div className="absolute -bottom-20 -right-20 w-[400px] h-[400px] rounded-full bg-brand-violet/5 dark:bg-brand-violet/3 blur-[80px] pointer-events-none" />

          {/* Giant watermark logomark */}
          <div className="absolute right-0 top-1/2 -translate-y-1/2 w-[400px] h-[400px] opacity-[0.03] dark:opacity-[0.05] pointer-events-none select-none hidden lg:block">
            <Image src="/images/logomark.png" alt="" fill className="object-contain" sizes="400px" priority />
          </div>
          ...
          <div className="relative w-full max-w-6xl mx-auto px-5 sm:px-8 py-16 md:py-24">
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              <div>
                ...
                <h1 className="text-6xl sm:text-7xl lg:text-8xl font-bold text-brand-green dark:text-brand-yellow leading-[0.9] mb-4 animate-fade-in-up">
                  gbóyinwá
                </h1>
        ...
        <section className="relative bg-brand-green dark:bg-[#060f06] overflow-hidden">
          <div className="absolute -top-48 -right-48 w-96 h-96 bg-brand-yellow/5 rounded-full blur-3xl pointer-events-none" />
          <div className="absolute -bottom-48 -left-48 w-96 h-96 bg-brand-violet/6 rounded-full blur-3xl pointer-events-none" />
            ...
            <AnimateIn>
              <div className="grid lg:grid-cols-2 gap-10 items-center">
                <div className="order-2 lg:order-1">
                  <div className="relative aspect-video rounded-2xl overflow-hidden shadow-2xl group">
                    ...
                    <div className="absolute bottom-4 left-4">
                      <span className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-brand-yellow text-brand-black text-sm font-bold">
                ...
                <div className="order-1 lg:order-2">
                  ...
                  <p className="text-lg text-brand-yellow/80 mb-4 font-light italic">
                  ...
                  <div className="grid grid-cols-2 gap-2 mb-6">
                    {[
                      ...
                      >
                        <Icon className="w-4 h-4 text-brand-yellow mb-1" />
                  ...
                  <Link
                    ...
                    className="inline-flex items-center gap-2 px-6 py-3 rounded-2xl bg-brand-yellow text-brand-black font-bold text-sm hover:bg-brand-yellow/90 active:scale-[0.98] transition-all shadow-lg shadow-brand-yellow/20"
                  >
                    Learn More
                    <ArrowRight className="w-4 h-4" />
                  </Link>
            ...
            <div className="grid md:grid-cols-3 gap-4">
              {[
                ...
                <AnimateIn key={i} delay={i * 100}>
                  <div className="group relative rounded-2xl glass-card p-6 overflow-hidden hover:border-brand-green/20 dark:hover:border-brand-yellow/20 hover:shadow-xl hover:shadow-brand-green/5 dark:hover:shadow-brand-yellow/5 transition-all duration-500 h-full hover-lift">
                    ...
                    <div className="relative z-10">
                      <div className="w-12 h-12 mb-4 rounded-xl bg-brand-green/8 dark:bg-brand-yellow/8 group-hover:bg-brand-green/15 dark:group-hover:bg-brand-yellow/15 flex items-center justify-center transition-colors duration-300">
                        <Icon className="w-6 h-6 text-brand-green dark:text-brand-yellow" />
                      </div>
                      ...
                      <div className={`mt-4 h-0.5 w-0 group-hover:w-10 bg-gradient-to-r ${gradient} transition-all duration-500 rounded-full`} />
                    </div>
                  </div>
                </AnimateIn>
              ))}
            ...
            <div className="max-w-6xl mx-auto">
              <AnimateIn>
                <div className="flex items-center gap-3 mb-6">
                  <div className="w-10 h-10 rounded-xl bg-brand-green dark:bg-brand-yellow flex items-center justify-center">
                    <Calendar className="w-5 h-5 text-white dark:text-brand-black" />
                  </div>
                  <div>
                    <h2 className="text-xl font-bold text-brand-green dark:text-brand-yellow">Upcoming Event</h2>
                    <p className="text-xs text-brand-black/50 dark:text-brand-yellow/50">Save the date</p>
                  </div>
                </div>
                ...
                >
                  <div className="grid md:grid-cols-5 gap-0">
                    <div className="md:col-span-2 relative aspect-video md:aspect-auto md:min-h-[240px]">
                      <Image
                    ...
                    <div className="md:col-span-3 p-6 md:p-8 flex flex-col justify-center">
                      <div className="flex flex-wrap items-center gap-2 mb-3">
                        {featured.start_date && (
                          <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-lg bg-brand-green/10 dark:bg-brand-yellow/10 text-brand-green dark:text-brand-yellow text-xs font-semibold">
                            <Calendar className="w-3.5 h-3.5" />
                            {new Date(featured.start_date).toLocaleDateString('en-NG', { weekday: 'short', month: 'short', day: 'numeric' })}
                          </span>
                        )}
                        {featured.location && (
                          <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-lg bg-brand-orange/10 text-brand-orange text-xs font-semibold">
                            <MapPin className="w-3.5 h-3.5" />
                            {featured.location}
                          </span>
                        )}
                      </div>
                      <h3 className="text-xl md:text-2xl font-bold text-brand-black dark:text-brand-yellow mb-2 group-hover:text-brand-green dark:group-hover:text-brand-yellow transition-colors">
                        {featured.title}
                      </h3>
                      {featured.summary && (
                        <p className="text-brand-black/60 dark:text-brand-yellow/60 mb-4 line-clamp-2 text-sm leading-relaxed">
                          {featured.summary}
                        </p>
                      )}
